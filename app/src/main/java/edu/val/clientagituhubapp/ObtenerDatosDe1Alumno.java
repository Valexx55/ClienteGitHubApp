...
public class ObtenerDatosDe1Alumno extends AsyncTask<Integer, Void, Alumno> {
    ...
    public ObtenerDatosDe1Alumno(Context context)
    {
        this.actividad_llamante = context;
    }

    @Override //en este método, se lleva a cabo la comunicación HTTP
    protected Alumno doInBackground(Integer... numeros) {
        Alumno alumno = null;
        ...
        try {
            ...
            url = new URL(URL_ALUMNOS+numeros[0]);
            ...
            if (httpURLConnection.getResponseCode() == HttpURLConnection.HTTP_OK) //200
            {
                ...
                alumno = gson.fromJson(inputStreamReader, Alumno.class);
            }
    ...
    protected void onPostExecute(Alumno alumno) {
        ...
        actividad_principal_UI.mostrarResultado1Alumno (alumno);
